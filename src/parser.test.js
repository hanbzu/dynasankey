...
describe('validateSimplifiedYaml', () => {
    ...
    it('should reject non-object input', () => {
        expect(() => validateSimplifiedYaml(null)).toThrow('YAML must be an object');
        expect(() => validateSimplifiedYaml('string')).toThrow('YAML must be an object');
        expect(() => validateSimplifiedYaml([])).toThrow('YAML must be an object');
    });
    ...
    it('should reject missing nodes array', () => {
        ...
        expect(() => validateSimplifiedYaml(yaml)).toThrow('YAML must contain a "nodes" array');
    });
    ...
    it('should reject missing flows array', () => {
        ...
        expect(() => validateSimplifiedYaml(yaml)).toThrow('YAML must contain a "flows" array');
    });
    ...
    it('should reject missing values object', () => {
        ...
        expect(() => validateSimplifiedYaml(yaml)).toThrow('YAML must contain a "values" object');
    });
    ...
    it('should reject node without id', () => {
        ...
        expect(() => validateSimplifiedYaml(yaml)).toThrow('Each node must have an "id" field');
    });
    ...
    it('should reject flow without id', () => {
        ...
        expect(() => validateSimplifiedYaml(yaml)).toThrow('Each flow must have an "id" field');
    });
    ...
    it('should reject flow without from field', () => {
        ...
        expect(() => validateSimplifiedYaml(yaml)).toThrow('Flow "f1" must have a "from" field');
    });
    ...
    it('should reject flow without to field', () => {
        ...
        expect(() => validateSimplifiedYaml(yaml)).toThrow('Flow "f1" must have a "to" field');
    });
});
...
describe('parseSimplifiedYaml', () => {
    describe('basic parsing', () => {
        ...
        it('should convert string flow formula to constraint', () => {
            ...
            expect(result.constraints).toEqual(['flows.f1 == parameters.total * 2']);
        });
        ...
        it('should preserve nodes and flows unchanged', () => {
            const yaml = {
                ...
                flows: [
                    { id: 'f1', from: 'A', to: 'B', label: 'Flow 1' },
                ],
            };
    ...
    describe('formula parsing with prefixes', () => {
        ...
        it('should add flows prefix to flow references', () => {
            ...
            expect(result.constraints).toContainEqual('flows.f2 == flows.f1 * 2');
        });
